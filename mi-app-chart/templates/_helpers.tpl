...
helm.sh/chart: {{ include "mi-app-chart.chart" . }}
...
*/}}
{{- define "mi-app-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mi-app-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
